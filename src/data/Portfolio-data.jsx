...
export const PROFILE = {
  ...
  export const PROJECTS = [
    {
        name: "OfficeEye - Office Facial Recognition",
    ...
    {
      name: "QualityLens - Fruit Classification Application",
    ...
    {
      name: "AI-PPLY - Applicant Tracking Systems",
    ...
    {
      name: "OptiCare - Hospital Scheduling System",
      tech: ["React Native", "Firebase", "Firestore", "FirebaseAuth"],
      desc: "A cross-platform mobile application using React Native to streamline hospital workflows, including appointment booking, instant messages and treatment scheduling.",
